...
Kardinal depends on two elements of your Kubernetes-deployed app:

1. A service dependency graph - every service defines its dependencies, including external APIs it uses to store or retrieve data.
