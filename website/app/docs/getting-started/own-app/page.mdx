...
It's not important that your production cluster use Istio - Kardinal will manage everything related to Istio on this development cluster, and your application should work just fine.
