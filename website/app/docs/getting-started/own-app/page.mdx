...
Getting started takes just a few minutes, assuming you have [installed Kardinal](../install) already. This guide will walk you through the steps to get started:
...
To use Kardinal with your application, you'll first need to [install Kardinal](../install).
