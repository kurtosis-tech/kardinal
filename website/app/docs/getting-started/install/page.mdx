...
Right now, Kardinal requires a complete dependency graph to be defined in your Kubernetes manifests for you to get started. We're working on removing this requirement, but for now, it's a must.
</Collapsible>
