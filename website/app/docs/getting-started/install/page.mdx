...
If you'd like to use a local Kubernetes cluster to try out Kardinal, you can refer to the first 2 steps of our [demo app guide](getting-started/demo) to get a local Kubernetes cluster up and running.
