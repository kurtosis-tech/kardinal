...
Right now, Kardinal requires a complete service dependency graph to be defined in your Kubernetes manifests for you to get started. We will remove this requirement very soon, but for now, it's a must.
</Collapsible>
