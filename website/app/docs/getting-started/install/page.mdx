...
To create a dev flow for this sample application, run:
```bash
kardinal flow create frontend kurtosistech/frontend:demo-frontend
```

```bash
curl -O https://raw.githubusercontent.com/kurtosis-tech/kardinal-playground/main/template.yaml;
curl -O https://raw.githubusercontent.com/kurtosis-tech/kardinal-playground/main/template_args.yaml;
