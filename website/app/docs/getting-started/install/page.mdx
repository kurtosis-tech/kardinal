...
If you have distributed tracing in your application (or can integrate it), and you're able to define dependencies per service in your deployment spec, you can install Kardinal today.
