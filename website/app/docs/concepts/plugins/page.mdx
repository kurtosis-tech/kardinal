export const metadata = {
  title: "Kardinal Docs | Stateful Service Plugins",
};
...
The `kardinal.dev.service/plugins` annotation uses a YAML-formatted list of plugins. Each plugin in the list has two main parts:
